...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       ApplicationContext applicationContext = new ClassPathXmlApplicationContext("file:C:\\Users\\JaroslavPC\\IdeaProjects\\cv02\\src\\main\\java\\app\\assignments\\app\\application-context.xml");
